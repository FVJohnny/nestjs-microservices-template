  ...
  describe('Filters', () => {
    describe('Equal Filter', () => {
      ...
      it('should filter by boolean field', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('isActive', Operator.EQUAL, 'true')]),
        });
    ...
    describe('Not Equal Filter', () => {
      it('should filter by not equal condition', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('status', Operator.NOT_EQUAL, 'inactive')]),
        });
    ...
    describe('Greater Than Filter', () => {
      ...
      it('should filter by greater than condition with dates', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('createdAt', Operator.GT, '2023-01-15')]),
        });
    ...
    describe('Contains Filter', () => {
      it('should filter by contains condition', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('email', Operator.CONTAINS, 'alice')]),
        });
      ...
      it('should be case insensitive for contains', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('name', Operator.CONTAINS, 'alice')]),
        });
    ...
    describe('Not Contains Filter', () => {
      it('should filter by not contains condition', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('email', Operator.NOT_CONTAINS, 'alice')]),
        });
    ...
    describe('Array Fields', () => {
      it('should handle array fields by joining them', () => {
        const entities = createBasicTestEntities();
        const criteria = new Criteria({
          filters: new Filters([createFilter('tags', Operator.CONTAINS, 'senior')]),
        });
