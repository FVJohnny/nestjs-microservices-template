...
export class DomainValidationException extends BaseException {
  constructor(field: string, value: unknown, rule: string, metadata?: Metadata) {
    super(
...
export class AggregateConstraintException extends BaseException {
  constructor(aggregateName: string, constraintName: string, details: string, metadata?: Metadata) {
    super(
